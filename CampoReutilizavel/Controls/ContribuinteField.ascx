...
<select id="dpContribuintes" class="form-control" name="dpContribuintes" ClientIDMode="Static"> </select>
    ...
    <br />
    <asp:Button ID="btnAdicionarLista" runat="server" Text="Adicionar a lista" CssClass="btn btn-dark" ClientIDMode="Static" OnClick="btnAdicionarLista_Click" Enabled="False"/>
    <br />
